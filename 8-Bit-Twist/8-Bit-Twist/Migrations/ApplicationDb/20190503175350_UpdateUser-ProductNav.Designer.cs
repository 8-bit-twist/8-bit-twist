...
namespace _8_Bit_Twist.Migrations.ApplicationDb
{
    ...
    [Migration("20190503175350_UpdateUser-ProductNav")]
    partial class UpdateUserProductNav
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("_8_Bit_Twist.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("_8_Bit_Twist.Models.Basket", b =>
                {
                    b.HasOne("_8_Bit_Twist.Models.ApplicationUser", "User")
                        .WithOne("Basket")
                        .HasForeignKey("_8_Bit_Twist.Models.Basket", "ApplicationUserID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
